            ...
            <div class="rounded-2xl border border-black/10 bg-white p-8 shadow-sm dark:border-white/10 dark:bg-[#141414]">
                ...
                <div class="mt-8 rounded-xl border border-black/10 bg-[#FCFCFB] p-5 shadow-sm dark:border-white/10 dark:bg-[#0f0f0f]">
                    ...
                    <ul class="list-disc space-y-1 pl-5 text-[13px] text-[#575654] dark:text-[#A1A09A]">
                        ...
                        <li><span class="font-medium">League data</span>: rosters, matchups, transactions, waivers, drafts, standings</li>
                        <li><span class="font-medium">Players and market</span>: search; trending adds/drops; ADP</li>
                        <li><span class="font-medium">Projections</span>: weekly projections; blend multiple sources</li>
                        <li><span class="font-medium">Lineups and decisions</span>: validate starters; optimize lineup; start/sit comparisons</li>
                        <li><span class="font-medium">Waivers and trades</span>: waiver recommendations; FAAB optimization; trade analysis</li>
                        <li><span class="font-medium">Draft helpers</span>: draft board; pick recommendations; live draft observe; draft picks</li>
                        <li><span class="font-medium">Roster analysis</span>: compute roster needs vs. starting slots</li>
                        <li><span class="font-medium">Planning and preferences</span>: playoff planning; strategy levers</li>
                        <li><span class="font-medium">Utilities</span>: context defaults; resolve current week; health check; cache; tool listing/schema</li>
                    </ul>
                </div>
