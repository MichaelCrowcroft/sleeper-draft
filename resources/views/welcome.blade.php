...
<x-layouts.app.marketing>
    <div class="min-h-screen bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC] px-6 py-12">
        <div class="mx-auto max-w-6xl">
            <header class="mb-6 flex justify-end">
                @if (Route::has('login'))
                    <nav class="flex items-center gap-4">
                        @auth
                            <a href="{{ url('/dashboard') }}" class="inline-flex items-center gap-2 rounded-md border border-black/10 bg-white px-4 py-2 text-sm font-medium text-black hover:bg-gray-50 dark:border-white/10 dark:bg-zinc-800 dark:text-white dark:hover:bg-zinc-700">
                                Dashboard
                            </a>
                        @else
                            <a href="{{ route('login') }}" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
                                Log in
                            </a>
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="inline-flex items-center gap-2 rounded-md border border-black/10 bg-white px-4 py-2 text-sm font-medium text-black hover:bg-gray-50 dark:border-white/10 dark:bg-zinc-800 dark:text-white dark:hover:bg-zinc-700">
                                    Register
                                </a>
                            @endif
                        @endauth
                ...
                <div class="grid items-start gap-10 lg:grid-cols-2">
                    <div>
                        <div class="flex items-center gap-4">
                            <img src="{{ asset('images/sleeper-draft-icon.png') }}" alt="Sleeper Draft" class="size-24">
                            <h1 class="text-3xl leading-snug font-semibold sm:text-4xl">MCP Tools for Fantasy Football</h1>
                        </div>
                        ...
                        <div class="mt-6 flex flex-wrap items-center gap-3">
                            <a href="https://github.com/MichaelCrowcroft/fantasy-football-mcp" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-md border border-black bg-black px-4 py-2 text-sm font-medium text-white hover:bg-[#1b1b18] dark:border-white dark:bg-white dark:text-[#1b1b18] dark:hover:bg-[#EDEDEC]">
                                View GitHub repo
                            ...
                            <a href="https://donate.stripe.com/3cI7sKcfB6sB0FC33le3e00" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-md border border-[#2563eb]/20 bg-[#eff6ff] px-4 py-2 text-sm font-medium text-[#2563eb] hover:bg-[#dbeafe] dark:border-[#60a5fa]/30 dark:bg-[#172554] dark:text-[#93c5fd] dark:hover:bg-[#1e293b]">
                                Support the project
                            </a>
                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="space-y-3">
                                        <div>
                                            ...
                                            <div class="overflow-auto rounded-md border border-[#2d2d2d] bg-[#1e1e1e] p-3 text-[12px] leading-relaxed text-white shadow-inner dark:border-[#2d2d2d] dark:bg-[#1e1e1e] dark:text-white"><pre><code class="hljs json">{
  "mcpServers": {
