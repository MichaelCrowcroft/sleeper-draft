...
new class extends Component
{
    ...
    public $selectedMetrics = [
        ...
        'owner' => true,
        'status' => true,
        // TE specific metrics (default on)
        'rec' => true,
        'rec_tgt' => true,
        'rec_yd' => true,
        'rec_td' => true,
        ...
        'rec_2pt' => true,
        'proj_pts_week' => true,
        // Additional TE metrics (default off)
        'rec_0_4' => false,
        'rec_5_9' => false,
        'rec_10_19' => false,
        'rec_20_29' => false,
    ...
    {
        $totalPlayers = Player::where('active', true)->where('position', 'TE')->count();
    ...
    {
        return Cache::remember('te_teams', now()->addHours(1), function () {
    ...
    public function getTrendingPicksProperty()
    {
        ...
        return collect([
            ['first_name' => 'Travis', 'last_name' => 'Kelce', 'trend_count' => 41],
            ['first_name' => 'Mark', 'last_name' => 'Andrews', 'trend_count' => 33],
            ['first_name' => 'George', 'last_name' => 'Kittle', 'trend_count' => 27],
        ]);
    }
    ...
    public function getTrendingDropsProperty()
    {
        // Mock data for now - in a real implementation, you'd fetch from an API
        return collect([
            ['first_name' => 'Dallas', 'last_name' => 'Goedert', 'trend_count' => 19],
            ['first_name' => 'T.J.', 'last_name' => 'Hockenson', 'trend_count' => 16],
            ['first_name' => 'David', 'last_name' => 'Njoku', 'trend_count' => 12],
        ]);
    }
}; ?>
...
<section class="w-full max-w-none">
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <flux:heading size="lg">Tight Ends</flux:heading>
                <p class="text-muted-foreground mt-1">Browse and analyze TE prospects with receiving and blocking metrics</p>
            </div>
        </div>
            ...
            <flux:callout>
                <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        @empty
                            <p class="text-muted-foreground">No trending TE picks available</p>
                        @endforelse
                    </div>
                </div>
            </flux:callout>
            ...
            <flux:callout>
                <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        @empty
                            <p class="text-muted-foreground">No trending TE drops available</p>
                        @endforelse
                    </div>
                </div>
            </flux:callout>
        ...
        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <flux:callout>
                <div class="text-center">
                    ...
                    <div class="text-sm text-muted-foreground">Total TEs</div>
                </div>
            </flux:callout>
            ...
            <flux:callout>
                <div class="text-center">
                    ...
                    <div class="text-sm text-muted-foreground">Injured TEs</div>
                </div>
            </flux:callout>
            ...
            <flux:callout>
                <div class="text-center">
                    ...
                    <div class="text-sm text-muted-foreground">Filtered TEs</div>
                </div>
            </flux:callout>
        </div>
        ...
        <flux:callout>
            <div class="space-y-4">
                <flux:heading size="sm">TE Metrics</flux:heading>
                <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <label class="flex items-center gap-2 text-sm">
        ...
        <flux:callout class="overflow-x-auto">
            <flux:heading size="md" class="mb-4">Tight End Data</flux:heading>
                        ...
                        <flux:table.row>
                            <flux:table.cell :colspan="$this->getColspan()" align="center">
                                <div class="py-8 text-muted-foreground">
                                    No tight ends found matching your filters.
                                </div>
                            </flux:table.cell>
                        </flux:table.row>
                    @endforelse
