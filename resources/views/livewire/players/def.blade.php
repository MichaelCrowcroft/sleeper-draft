...
new class extends Component
{
    ...
    public $selectedMetrics = [
        ...
        'owner' => true,
        'status' => true,
        // DEF specific metrics (default on)
        'def_fum_td' => true,
        'fum' => true,
        'fum_lost' => true,
        'proj_pts_week' => true,
        // Additional DEF metrics (default off)
        'pass_int' => false,
        'pass_sack' => false,
        'rush_td' => false,
        'rec_td' => false,
    ...
    {
        $totalPlayers = Player::where('active', true)->where('position', 'DEF')->count();
    ...
    {
        return Cache::remember('def_teams', now()->addHours(1), function () {
    ...
    public function getTrendingPicksProperty()
    {
        ...
        return collect([
            ['first_name' => 'San Francisco', 'last_name' => '49ers', 'trend_count' => 28],
            ['first_name' => 'Buffalo', 'last_name' => 'Bills', 'trend_count' => 24],
            ['first_name' => 'New England', 'last_name' => 'Patriots', 'trend_count' => 19],
        ]);
    }
    ...
    public function getTrendingDropsProperty()
    {
        // Mock data for now - in a real implementation, you'd fetch from an API
        return collect([
            ['first_name' => 'Jacksonville', 'last_name' => 'Jaguars', 'trend_count' => 16],
            ['first_name' => 'Carolina', 'last_name' => 'Panthers', 'trend_count' => 13],
            ['first_name' => 'Detroit', 'last_name' => 'Lions', 'trend_count' => 11],
        ]);
    }
}; ?>
...
<section class="w-full max-w-none">
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <flux:heading size="lg">Defenses</flux:heading>
                <p class="text-muted-foreground mt-1">Browse and analyze defensive and special teams units</p>
            </div>
        </div>
            ...
            <flux:callout>
                <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        @empty
                            <p class="text-muted-foreground">No trending DEF picks available</p>
                        @endforelse
                    </div>
                </div>
            </flux:callout>
            ...
            <flux:callout>
                <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        @empty
                            <p class="text-muted-foreground">No trending DEF drops available</p>
                        @endforelse
                    </div>
                </div>
            </flux:callout>
        ...
        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <flux:callout>
                <div class="text-center">
                    ...
                    <div class="text-sm text-muted-foreground">Total DEF</div>
                </div>
            </flux:callout>
            ...
            <flux:callout>
                <div class="text-center">
                    ...
                    <div class="text-sm text-muted-foreground">Injured DEF</div>
                </div>
            </flux:callout>
            ...
            <flux:callout>
                <div class="text-center">
                    ...
                    <div class="text-sm text-muted-foreground">Filtered DEF</div>
                </div>
            </flux:callout>
        </div>
        ...
        <flux:callout>
            <div class="space-y-4">
                <flux:heading size="sm">DEF Metrics</flux:heading>
                <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <label class="flex items-center gap-2 text-sm">
                ...
                <div class="mt-4">
                    <flux:heading size="xs">Defensive & Special Teams Stats (per game)</flux:heading>
                    <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mt-2">
                        ...
                        <label class="flex items-center gap-2 text-sm"><flux:switch wire:model.live="selectedMetrics.fum" /><span>Fumbles Forced</span></label>
                        ...
                        <label class="flex items-center gap-2 text-sm"><flux:switch wire:model.live="selectedMetrics.pass_sack" /><span>Sacks</span></label>
                        <label class="flex items-center gap-2 text-sm"><flux:switch wire:model.live="selectedMetrics.rush_td" /><span>Rush TDs Allowed</span></label>
                        <label class="flex items-center gap-2 text-sm"><flux:switch wire:model.live="selectedMetrics.rec_td" /><span>Rec TDs Allowed</span></label>
                    </div>
                </div>
            </div>
        </flux:callout>
        ...
        <flux:callout class="overflow-x-auto">
            <flux:heading size="md" class="mb-4">Defense & Special Teams Data</flux:heading>
                        ...
                        <flux:table.row>
                            <flux:table.cell :colspan="$this->getColspan()" align="center">
                                <div class="py-8 text-muted-foreground">
                                    No defenses found matching your filters.
                                </div>
                            </flux:table.cell>
                        </flux:table.row>
                    @endforelse
