...
new class extends Component
{
    ...
    public $selectedMetrics = [
        ...
        'owner' => true,
        'status' => true,
        // K specific metrics (default on) - limited availability
        'proj_pts_week' => true,
        // Additional K metrics (default off)
        'pass_td' => false,
        'rush_td' => false,
        'rec_td' => false,
    ];
    ...
    {
        $totalPlayers = Player::where('active', true)->where('position', 'K')->count();
    ...
    {
        return Cache::remember('k_teams', now()->addHours(1), function () {
    ...
    public function getTrendingPicksProperty()
    {
        ...
        return collect([
            ['first_name' => 'Justin', 'last_name' => 'Tucker', 'trend_count' => 22],
            ['first_name' => 'Harrison', 'last_name' => 'Butker', 'trend_count' => 19],
            ['first_name' => 'Evan', 'last_name' => 'McPherson', 'trend_count' => 16],
        ]);
    }
    ...
    public function getTrendingDropsProperty()
    {
        // Mock data for now - in a real implementation, you'd fetch from an API
        return collect([
            ['first_name' => 'Younghoe', 'last_name' => 'Koo', 'trend_count' => 13],
            ['first_name' => 'Jake', 'last_name' => 'Elliott', 'trend_count' => 10],
            ['first_name' => 'Tyler', 'last_name' => 'Bass', 'trend_count' => 8],
        ]);
    }
}; ?>
...
<section class="w-full max-w-none">
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <flux:heading size="lg">Kickers</flux:heading>
                <p class="text-muted-foreground mt-1">Browse and analyze kicker prospects and field goal specialists</p>
            </div>
        </div>
            ...
            <flux:callout>
                <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        @empty
                            <p class="text-muted-foreground">No trending K picks available</p>
                        @endforelse
                    </div>
                </div>
            </flux:callout>
            ...
            <flux:callout>
                <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        @empty
                            <p class="text-muted-foreground">No trending K drops available</p>
                        @endforelse
                    </div>
                </div>
            </flux:callout>
        ...
        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <flux:callout>
                <div class="text-center">
                    ...
                    <div class="text-sm text-muted-foreground">Total Kickers</div>
                </div>
            </flux:callout>
            ...
            <flux:callout>
                <div class="text-center">
                    ...
                    <div class="text-sm text-muted-foreground">Injured Kickers</div>
                </div>
            </flux:callout>
            ...
            <flux:callout>
                <div class="text-center">
                    ...
                    <div class="text-sm text-muted-foreground">Filtered Kickers</div>
                </div>
            </flux:callout>
        </div>
        ...
        <flux:callout>
            <div class="space-y-4">
                <flux:heading size="sm">Kicker Metrics</flux:heading>
                <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <label class="flex items-center gap-2 text-sm">
                ...
                <div class="mt-4">
                    <flux:heading size="xs">Kicker Stats</flux:heading>
        ...
        <flux:callout class="overflow-x-auto">
            <flux:heading size="md" class="mb-4">Kicker Data</flux:heading>
                        ...
                        <flux:table.row>
                            <flux:table.cell :colspan="$this->getColspan()" align="center">
                                <div class="py-8 text-muted-foreground">
                                    No kickers found matching your filters.
                                </div>
                            </flux:table.cell>
                        </flux:table.row>
                    @endforelse
