...
new class extends Component
{
    ...
    public $selectedMetrics = [
        ...
        'owner' => true,
        'status' => true,
        // RB specific metrics (default on)
        'rush_att' => true,
        'rush_yd' => true,
        'rush_td' => true,
        'rush_fd' => true,
        ...
        'rec_fd' => true,
        'proj_pts_week' => true,
        // Additional RB metrics (default off)
        'rec_0_4' => false,
        'rec_5_9' => false,
        'rec_10_19' => false,
        'rec_20_29' => false,
    ...
    {
        $totalPlayers = Player::where('active', true)->where('position', 'RB')->count();
    ...
    {
        return Cache::remember('rb_teams', now()->addHours(1), function () {
    ...
    public function getTrendingPicksProperty()
    {
        ...
        return collect([
            ['first_name' => 'Christian', 'last_name' => 'McCaffrey', 'trend_count' => 32],
            ['first_name' => 'Austin', 'last_name' => 'Ekeler', 'trend_count' => 28],
            ['first_name' => 'Derrick', 'last_name' => 'Henry', 'trend_count' => 22],
        ]);
    }
    ...
    public function getTrendingDropsProperty()
    {
        // Mock data for now - in a real implementation, you'd fetch from an API
        return collect([
            ['first_name' => 'Dalvin', 'last_name' => 'Cook', 'trend_count' => 15],
            ['first_name' => 'Nick', 'last_name' => 'Chubb', 'trend_count' => 11],
            ['first_name' => 'Alvin', 'last_name' => 'Kamara', 'trend_count' => 9],
        ]);
    }
}; ?>
...
<section class="w-full max-w-none">
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <flux:heading size="lg">Running Backs</flux:heading>
                <p class="text-muted-foreground mt-1">Browse and analyze RB prospects with rushing and receiving metrics</p>
            </div>
        </div>
            ...
            <flux:callout>
                <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        @empty
                            <p class="text-muted-foreground">No trending RB picks available</p>
                        @endforelse
                    </div>
                </div>
            </flux:callout>
            ...
            <flux:callout>
                <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        @empty
                            <p class="text-muted-foreground">No trending RB drops available</p>
                        @endforelse
                    </div>
                </div>
            </flux:callout>
        ...
        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <flux:callout>
                <div class="text-center">
                    ...
                    <div class="text-sm text-muted-foreground">Total RBs</div>
                </div>
            </flux:callout>
            ...
            <flux:callout>
                <div class="text-center">
                    ...
                    <div class="text-sm text-muted-foreground">Injured RBs</div>
                </div>
            </flux:callout>
            ...
            <flux:callout>
                <div class="text-center">
                    ...
                    <div class="text-sm text-muted-foreground">Filtered RBs</div>
                </div>
            </flux:callout>
        </div>
        ...
        <flux:callout>
            <div class="space-y-4">
                <flux:heading size="sm">RB Metrics</flux:heading>
                <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <label class="flex items-center gap-2 text-sm">
                ...
                <div class="mt-4">
                    <flux:heading size="xs">Rushing & Receiving Stats (per game)</flux:heading>
        ...
        <flux:callout class="overflow-x-auto">
            <flux:heading size="md" class="mb-4">Running Back Data</flux:heading>
                        ...
                        <flux:table.row>
                            <flux:table.cell :colspan="$this->getColspan()" align="center">
                                <div class="py-8 text-muted-foreground">
                                    No running backs found matching your filters.
                                </div>
                            </flux:table.cell>
                        </flux:table.row>
                    @endforelse
