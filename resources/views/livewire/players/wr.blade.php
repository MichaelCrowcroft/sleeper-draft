...
new class extends Component
{
    ...
    public $selectedMetrics = [
        ...
        'owner' => true,
        'status' => true,
        // WR specific metrics (default on)
        'rec' => true,
        'rec_tgt' => true,
        'rec_yd' => true,
        'rec_td' => true,
        ...
        'rec_30_39' => true,
        'proj_pts_week' => true,
        // Additional WR metrics (default off)
        'rec_2pt' => false,
        'fum' => false,
        'fum_lost' => false,
    ];
    ...
    {
        $totalPlayers = Player::where('active', true)->where('position', 'WR')->count();
    ...
    {
        return Cache::remember('wr_teams', now()->addHours(1), function () {
    ...
    public function getTrendingPicksProperty()
    {
        ...
        return collect([
            ['first_name' => 'Tyreek', 'last_name' => 'Hill', 'trend_count' => 35],
            ['first_name' => 'Ja\'Marr', 'last_name' => 'Chase', 'trend_count' => 28],
            ['first_name' => 'Stefon', 'last_name' => 'Diggs', 'trend_count' => 24],
        ]);
    }
    ...
    public function getTrendingDropsProperty()
    {
        // Mock data for now - in a real implementation, you'd fetch from an API
        return collect([
            ['first_name' => 'Mike', 'last_name' => 'Evans', 'trend_count' => 18],
            ['first_name' => 'Amari', 'last_name' => 'Cooper', 'trend_count' => 14],
            ['first_name' => 'Keenan', 'last_name' => 'Allen', 'trend_count' => 11],
        ]);
    }
}; ?>
...
<section class="w-full max-w-none">
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <flux:heading size="lg">Wide Receivers</flux:heading>
                <p class="text-muted-foreground mt-1">Browse and analyze WR prospects with receiving and yardage metrics</p>
            </div>
        </div>
            ...
            <flux:callout>
                <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        @empty
                            <p class="text-muted-foreground">No trending WR picks available</p>
                        @endforelse
                    </div>
                </div>
            </flux:callout>
            ...
            <flux:callout>
                <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        @empty
                            <p class="text-muted-foreground">No trending WR drops available</p>
                        @endforelse
                    </div>
                </div>
            </flux:callout>
        ...
        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <flux:callout>
                <div class="text-center">
                    ...
                    <div class="text-sm text-muted-foreground">Total WRs</div>
                </div>
            </flux:callout>
            ...
            <flux:callout>
                <div class="text-center">
                    ...
                    <div class="text-sm text-muted-foreground">Injured WRs</div>
                </div>
            </flux:callout>
            ...
            <flux:callout>
                <div class="text-center">
                    ...
                    <div class="text-sm text-muted-foreground">Filtered WRs</div>
                </div>
            </flux:callout>
        </div>
        ...
        <flux:callout>
            <div class="space-y-4">
                <flux:heading size="sm">WR Metrics</flux:heading>
                <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <label class="flex items-center gap-2 text-sm">
                ...
                <div class="mt-4">
                    <flux:heading size="xs">Receiving Stats (per game)</flux:heading>
        ...
        <flux:callout class="overflow-x-auto">
            <flux:heading size="md" class="mb-4">Wide Receiver Data</flux:heading>
                        ...
                        <flux:table.row>
                            <flux:table.cell :colspan="$this->getColspan()" align="center">
                                <div class="py-8 text-muted-foreground">
                                    No wide receivers found matching your filters.
                                </div>
                            </flux:table.cell>
                        </flux:table.row>
                    @endforelse
