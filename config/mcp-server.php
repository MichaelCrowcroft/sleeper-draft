...
return [
    ...
    */
    'tools' => [
        ...
        // Unified tools
        App\MCP\Tools\Recommendations\UnifiedRecommendationsTool::class,
        App\MCP\Tools\Lineup\UnifiedLineupTool::class,
        App\MCP\Tools\Data\UnifiedDataTool::class,
